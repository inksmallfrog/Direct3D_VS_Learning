...
HRESULT Objects_Init(HWND hwnd){
	...
	HR(g_pd3dDevice->CreateVertexBuffer(8 * sizeof(CustomVertex), 0,
		D3DFVF_CUSTOMVERTEX, D3DPOOL_DEFAULT, &g_pVertexBuffer, NULL));
	HR(g_pd3dDevice->CreateIndexBuffer(36 * sizeof(WORD), 0,
	...
	WORD *pIndices = NULL;
	HR(g_pIndexBuffer->Lock(0, sizeof(Indices), (void**)&pIndices, 0));
